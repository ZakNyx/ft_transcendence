...
const ChannelInfo: FC<ChannelInfoProps> = () => {
    const [buttons, setButton] = useState<number>(1);
    return (
        <div className={classes.infoCard}>
            <div className={classes.header}>
                <img className={classes.channelImage} src="https://i.pinimg.com/474x/ec/e2/b0/ece2b0f541d47e4078aef33ffd22777e.jpg" alt="Channel Image" />
