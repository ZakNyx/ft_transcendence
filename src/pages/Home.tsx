    ...
    <div className="background-image min-h-screen">
      ...
      <div className="flex flex-col items-center justify-center">
        <div className="flex items-center h-[65vh]">
          <button className="relative bg-npc-purple hover:bg-purple-hover hover:cursor-pointer text-black font-[Roboto] font-bold  text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl sm:p-3 xl:p-4 rounded-lg flex items-center">
